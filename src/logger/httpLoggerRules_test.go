...
func TestUsesRemoveRules() {

}

// test uses remove if rules

func TestUsesRemoveIfRules() {

}

// test uses remove if found rules

func TestUsesRemoveIfFoundRules() {

}

// test uses remove unless rules

func TestUsesRemoveUnlessRules() {

}

// test uses remove unless found rules

func TestUsesRemoveUnlessFoundRules() {

}

// test uses replace rules

func TestUsesReplaceRules() {

}

// test uses replace rules with complex expressions

func TestUsesReplaceRulesWithComplexExpressions() {

}

// test uses sample rules

func TestUsesSampleRules() {

}

// test uses skip compression rules

func TestUsesSkipCompressionRules() {

}

// test uses skip submission rules

func TestUsesSkipSubmissionRules() {

}

// test uses stop rules

func TestUsesStopRules() {

}

// test uses stop if rules

func TestUsesStopIfRules() {

}

// test uses stop if found rules

func TestUsesStopIfFoundRules() {

}

// test uses stop unless rules

func TestUsesStopUnlessRules() {

}

// test uses stop unless found rules

func TestUsesStopUnlessFoundRules() {
