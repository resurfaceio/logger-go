...
func TestUsesSampleRules(t *testing.T) {
	...
	assert.GreaterOrEqual(t, len(queue), 2, "sample amount is less than specified 10")
	assert.LessOrEqual(t, len(queue), 20, "sample amount is greater than specified 10")
}
