...
var helperBodies = map[string][]byte{
...
func MockGetPlainTextResponse(request *http.Request) http.Response {
	return MockGetResponseWithBody(request, helperBodies["plain"], "text/plain")
}

func MockGetJSONResponse(request *http.Request) http.Response {
	return MockGetResponseWithBody(request, helperBodies["json"], "application/json")
}

func MockGetJPEGResponse(request *http.Request) http.Response {
	return MockGetResponseWithBody(request, helperBodies["jpg"], "image/jpeg")
}

func MockGetJSONEncodedResponse(request *http.Request, encoding string) http.Response {
	body := helperBodies[encoding]
	headers := map[string][]string{
		"Content-Length":   {strconv.Itoa(len(body))},
